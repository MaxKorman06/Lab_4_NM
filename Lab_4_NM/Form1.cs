        ...
        private void button_calculate_Click(object sender, EventArgs e)
        {
            ...
            // Метод Ейлера
            {
                ...
                for (int i = 0; i < arr_size; i++)
                {
                    ...
                    ffunc = (8 * arr_y[i]) / Math.Pow(arr_x[i] + 4,2);
            ...
            // Метод додаткового півкроку
            {
                ...
                for (int i = 0; i < arr_size; i++)
                {
                    ...
                    ffunc_h = (8 * arr_yh[i]) / Math.Pow((arr_x[i] + h_h / 2) + 4, 2);
            ...
            // Метод пробного кроку
            {
                ...
                for (int i = 0; i < arr_size; i++)
                {
                    ...
                    ffunc_h = (8 * arr_yh[i]) / Math.Pow((arr_x[i]) + 4, 2);
            ...
            // Метод Рунге-Кутта
            {
                ...
                for (int i = 0; i < arr_size; i++)
                {
                    ...
                    ffunc_h1 = (8 * (arr_y[i] + arr_k[0] / 2)) / Math.Pow((arr_x[i] + h_h / 2) + 4, 2);

                    arr_k[1] = h_h * ffunc_h1;

                    ffunc_h2 = (8 * (arr_y[i] + arr_k[1] / 2)) / Math.Pow((arr_x[i] + h_h / 2) + 4, 2);

                    arr_k[2] = h_h * ffunc_h2;

                    ffunc_h3 = (8 * (arr_y[i] + arr_k[2])) / Math.Pow((arr_x[i] + h_h) + 4, 2);
